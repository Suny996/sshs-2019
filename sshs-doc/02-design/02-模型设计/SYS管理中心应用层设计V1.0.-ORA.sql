...
COMMENT ON COLUMN SYS_MENU.PARENT_CODE IS  '所属父菜单';
...
CONSTRAINT SYS_DICTIONARY PRIMARY KEY (DICT_ID)
 ...
 COMMENT ON COLUMN SYS_DICTIONARY.DICT_ID IS  'ID';
COMMENT ON COLUMN SYS_DICTIONARY.PARENT_ID IS  '上级ID';
COMMENT ON COLUMN SYS_DICTIONARY.DICT_TYPE IS  '类型:0-分类,1-字典项,2-字典子项,3-字典码值';
COMMENT ON COLUMN SYS_DICTIONARY.DICT_CODE IS  '代码';
COMMENT ON COLUMN SYS_DICTIONARY.DICT_NAME IS  '名称';
COMMENT ON COLUMN SYS_DICTIONARY.DICT_DESC IS  '描述';
COMMENT ON COLUMN SYS_DICTIONARY.STATUS IS  '状态1:有效0:无效';
COMMENT ON COLUMN SYS_DICTIONARY.SORT_NO IS  '排序';
COMMENT ON COLUMN SYS_DICTIONARY.IS_SYSTEM IS  '是否系统类1:系统类0:业务类';
COMMENT ON COLUMN SYS_DICTIONARY.MODULE IS  '模块';
COMMENT ON COLUMN SYS_DICTIONARY.LEGAL_ORG IS  '法人行社';
COMMENT ON COLUMN SYS_DICTIONARY.CRT_USER_CODE IS  '创建人';
COMMENT ON COLUMN SYS_DICTIONARY.CRT_ORG_CODE IS  '创建机构';
COMMENT ON COLUMN SYS_DICTIONARY.CRT_DATE IS  '创建日期';
COMMENT ON COLUMN SYS_DICTIONARY.UPD_USER_CODE IS  '修改人';
COMMENT ON COLUMN SYS_DICTIONARY.UPD_ORG_CODE IS  '修改机构';
COMMENT ON COLUMN SYS_DICTIONARY.UPD_DATE IS  '修改日期';
...
CONSTRAINT SYS_DICTIONARY_I18N PRIMARY KEY (I18N_ID)
 ...
 COMMENT ON COLUMN SYS_DICTIONARY_I18N.I18N_ID IS  'I18N_ID';
COMMENT ON COLUMN SYS_DICTIONARY_I18N.DICT_ID IS  'ID';
COMMENT ON COLUMN SYS_DICTIONARY_I18N.DICT_CODE IS  '代码';
COMMENT ON COLUMN SYS_DICTIONARY_I18N.LANGUAGE IS  '语言';
COMMENT ON COLUMN SYS_DICTIONARY_I18N.COUNTRY IS  '国家';
COMMENT ON COLUMN SYS_DICTIONARY_I18N.DICT_NAME IS  '名称';
COMMENT ON COLUMN SYS_DICTIONARY_I18N.DICT_DESC IS  '描述';
COMMENT ON COLUMN SYS_DICTIONARY_I18N.STATUS IS  '状态1:有效0:无效';
COMMENT ON COLUMN SYS_DICTIONARY_I18N.LEGAL_ORG IS  '法人行社';
COMMENT ON COLUMN SYS_DICTIONARY_I18N.UPD_USER_CODE IS  '修改人';
COMMENT ON COLUMN SYS_DICTIONARY_I18N.UPD_DATE IS  '修改日期';
...
COMMENT ON COLUMN SYS_LOG.USER_CODE IS  '操作用户编号';
COMMENT ON COLUMN SYS_LOG.USER_NAME IS  '操作用户名称';
COMMENT ON COLUMN SYS_LOG.MODULE IS  '模块';
COMMENT ON COLUMN SYS_LOG.ACTION IS  '操作内容';
COMMENT ON COLUMN SYS_LOG.OPT_DATE IS  '操作时间';
COMMENT ON COLUMN SYS_LOG.CLIENT_IP IS  '客户端IP地址';
COMMENT ON COLUMN SYS_LOG.METHOD IS  '执行方法名';
COMMENT ON COLUMN SYS_LOG.PARAMS IS  '输入参数';
COMMENT ON COLUMN SYS_LOG.OPT_DESC IS  '描述';
COMMENT ON COLUMN SYS_LOG.LEGAL_ORG IS  '法人行社';
COMMENT ON COLUMN SYS_LOG.CRT_USER_CODE IS  '创建人';
COMMENT ON COLUMN SYS_LOG.CRT_ORG_CODE IS  '创建机构';
COMMENT ON COLUMN SYS_LOG.CRT_DATE IS  '创建日期';
COMMENT ON COLUMN SYS_LOG.UPD_USER_CODE IS  '修改人';
COMMENT ON COLUMN SYS_LOG.UPD_ORG_CODE IS  '修改机构';
COMMENT ON COLUMN SYS_LOG.UPD_DATE IS  '修改日期';
