...
CREATE TABLE SYS_DICTIONARIY(
  ...
  UPD_ORG_CODE  VARCHAR2 (32),
  UPD_DATE  DATE,
CONSTRAINT SYS_DICTIONARIY PRIMARY KEY (DICT_ID)
);
 COMMENT ON TABLE SYS_DICTIONARIY IS '系统管理-数据字典表';
 COMMENT ON COLUMN SYS_DICTIONARIY.DICT_ID IS  'ID';
COMMENT ON COLUMN SYS_DICTIONARIY.PARENT_ID IS  '上级ID';
COMMENT ON COLUMN SYS_DICTIONARIY.DICT_TYPE IS  '类型:0-分类,1-字典项,2-字典子项,3-字典码值';
COMMENT ON COLUMN SYS_DICTIONARIY.DICT_CODE IS  '代码';
COMMENT ON COLUMN SYS_DICTIONARIY.DICT_NAME IS  '名称';
COMMENT ON COLUMN SYS_DICTIONARIY.DICT_DESC IS  '描述';
COMMENT ON COLUMN SYS_DICTIONARIY.STATUS IS  '状态1:有效0:无效';
COMMENT ON COLUMN SYS_DICTIONARIY.SORT_NO IS  '排序';
COMMENT ON COLUMN SYS_DICTIONARIY.IS_SYSTEM IS  '是否系统类1:系统类0:业务类';
COMMENT ON COLUMN SYS_DICTIONARIY.MODULE IS  '模块';
COMMENT ON COLUMN SYS_DICTIONARIY.LEGAL_ORG IS  '法人行社';
COMMENT ON COLUMN SYS_DICTIONARIY.CRT_USER_CODE IS  '创建人';
COMMENT ON COLUMN SYS_DICTIONARIY.CRT_ORG_CODE IS  '创建机构';
COMMENT ON COLUMN SYS_DICTIONARIY.CRT_DATE IS  '创建日期';
COMMENT ON COLUMN SYS_DICTIONARIY.UPD_USER_CODE IS  '修改人';
COMMENT ON COLUMN SYS_DICTIONARIY.UPD_ORG_CODE IS  '修改机构';
COMMENT ON COLUMN SYS_DICTIONARIY.UPD_DATE IS  '修改日期';
...
COMMENT ON COLUMN SYS_LOG.DICT_DESC IS  '描述';
