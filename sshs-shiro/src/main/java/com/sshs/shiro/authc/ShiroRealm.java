...
public class ShiroRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        Set<String> roleSet = new HashSet<>();//sysUserService.getUserRolesSet(username);
        info.setRoles(roleSet);

        // 设置用户拥有的权限集合，比如“sys:role:add,sys:user:add”
        Set<String> permissionSet = new HashSet();//sysUserService.getUserPermissionsSet(username);
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken auth) throws AuthenticationException {
        ...
        if (token == null) {
            log.info("————————身份认证失败——————————IP地址:  " + SystemUtil.getRemoteIp());
    ...
    public LoginUser checkUserTokenIsEffect(String token) throws AuthenticationException {
        ...
        List<LoginUser> users = loginUserMapper.findSecurityUserByUserName(username);
