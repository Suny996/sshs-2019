package com.sshs.shiro.configuration;
...
public class ShiroSwaggerConfig implements WebMvcConfigurer {
    /**
   ...
   /* @Override
    ...
    public Docket shiroApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("安全接口(SHIRO)").select().apis(RequestHandlerSelectors.basePackage("com.sshs.shiro"))
